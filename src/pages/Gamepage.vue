<template>
    <div>
        <div class="c-nav">
            ...
            <button class="c-nav-list-item" @click="goToPage('ranking')">RANKING</button>
        </div>
        <h1 class="header">
            Game
        </h1>
    ...
    export default {
        ...
        methods: {
            ...
            addVote(points){
                ...
                //create new array when pointsk is equal to given points, change isvoted state so
                votes.map((vote) => {
                ...
                //check if all votes isvoted are set to true or no false votes
